...
## Jiyu_udp_attack(v1.4)

- 代码重构，优化参数选取逻辑
- 反弹shell功能增加随机端口
- 更新文档

- GitHub 仓库地址:[https://github.com/ht0Ruial/Jiyu_udp_attack](https://github.com/ht0Ruial/Jiyu_udp_attack)  
- 程序下载地址:[Jiyu_udp_attack_x86.zip](https://github.com/ht0Ruial/Jiyu_udp_attack/releases/download/v1.4/Jiyu_udp_attack_x86.zip),[Jiyu_udp_attack_x86_64.zip](https://github.com/ht0Ruial/Jiyu_udp_attack/releases/download/v1.4/Jiyu_udp_attack_x86_64.zip)
...
(可选) sc delete TDFileFilter
```

### 网络限制

在访问任意时,如果跳转网页,网页内容为`网页已被阻止`或类似内容时:
